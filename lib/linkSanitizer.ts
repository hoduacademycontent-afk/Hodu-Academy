export function sanitizeContentLinks(html: string): string {
  ...
  clean = clean.replace(/https?:\/\/(?:courses\.)?hoduacademy\.com\/tests\/[^\s"'>]+/gi, 'https://portal.hoduacademy.com/hodu-academy/learner-login')
  clean = clean.replace(/https?:\/\/(?:www\.)?hoduacademy\.com\/mod\/quiz\/[^\s"'>]+/gi, 'https://portal.hoduacademy.com/hodu-academy/learner-login')
  ...
  clean = clean.replace(/https?:\/\/(?:www\.)?hoduacademy\.com\/login\/[^"'\s<>]*/gi, 'https://portal.hoduacademy.com/hodu-academy/learner-login')
  clean = clean.replace(/https?:\/\/(?:www\.)?hoduacademy\.com\/user\/[^"'\s<>]*/gi, 'https://portal.hoduacademy.com/hodu-academy/learner-login')
